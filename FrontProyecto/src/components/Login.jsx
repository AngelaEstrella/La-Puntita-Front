...
export default function Login() {
    ...
    const handleSubmit = (event) => {
        ...
        if (correo === "admin@lapuntita.com" && contraseña === "admin123") {
            setError(false);
            setOpenAlert(true);
        } else {
            setError(true);
...
export default function Login() {
    ...
    const [contraseña, setContraseña] = useState(""); 
    const [error, setError] = useState(false);
    const [userId, setUserId] = useState(null); // Guardará el ID de usuario si es correcto
...
export default function Login() {
    ...
    const handleSubmit = (event) => {
        ...
        const formData = {
            username: correo, // OAuth2PasswordRequestForm espera 'username'
            password: contraseña // OAuth2PasswordRequestForm espera 'password'
        };
...
export default function Login() {
    ...
    const handleSubmit = (event) => {
        ...
        const formData = new FormData();
        formData.append("username", correo); // OAuth2PasswordRequestForm espera 'username'
        formData.append("password", contraseña); // OAuth2PasswordRequestForm espera 'password'
